...
madrid_districts_dict = {
    ...
    "Centro": ["Cortes", "Embajadores", "Justicia", "Universidad", "Palacio", "Sol"],
    ...
    "Ciudad Lineal": ["Atalaya", "Colina", "Concepción", "Pinar de Chamartín", "Pueblo Nuevo", "Quintana", "San Juan Bautista", "San Pascual", "Ventas"],
    "Fuencarral-El Pardo": ["Barrio del Pilar", "El Goloso", "El Pardo", "Fuentelarreina", "La Paz", "Mirasierra", "Peñagrande", "Valverde"],
    "Hortaleza": ["Apóstol Santiago", "Canillas", "Palomas", "Pinar del Rey", "Piovera", "Valdefuentes"],
    "Latina": ["Aluche", "Campamento", "Cuatro Vientos", "Las Águilas", "Lucero", "Los Cármenes", "Puerta del Ángel"],
    ...
    "Usera": ["Almendrales", "Moscardó", "Orcasitas", "Orcasur", "Pradolongo", "San Fermín", "Zofio"],
    "Vicálvaro": ["Ambroz", "Casco Histórico de Vicálvaro", 'El Cañaveral', 'Valdebernardo', 'Los Berrocales', 'Los Cerros'],
    "Villa de Vallecas": ["Casco Histórico de Vallecas", "Santa Eugenia"],
    "Villaverde": ["Butarque", "Los Ángeles", "Los Rosales", "San Cristóbal de los Ángeles", "Villaverde Alto"]
}
...
model_pipeline = load_model('final_model')

st.title('Madrid House Price Prediction')

# Load the district data
district_data = pd.read_csv('scraped_data_cleaned_Emanuela_22Jul24.csv')
